...
complete -c leaf -l show-keymap-actions -x -a "global viewer" -d "Show effective bindings and actions"
complete -c leaf -l include-hidden-keymap-actions -d "Include internal actions in keymap output"
